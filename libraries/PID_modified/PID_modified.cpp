...
void PID::SetTunings(double Kp, double Ki, double Kd, int POn)
{
   ...
   //  We insert the contribution from time everytime we call compute, so that we are not restricted
   //  to a fixed cycle time (unlike the original library, see commented code below)
   ki = Ki; 
   kd = Kd;
